        ...
        [
            'form_fields' => [
                ...
                'product_free_shipping_exclusion' => [
                    'display_name'  => 'Free Shipping Exclusion',
                    'property_type' => 'checkbox',
                    'description'   => __(
                        'If checked, free shipping (amount or product trigger) will not apply when this product is in the cart.',
                        'the-courier-guy'
                    ),
                    'placeholder'   => '',
                    'default'       => '0',
                ...
                'product_prohibit_tcg'            => [
                    ...
                    'property_type' => 'checkbox',
                    'description'   => __(
                        'Enable to prohibit The Courier Guy shipping if baskets contains this product',
                        'the-courier-guy'
                    ),
                    'placeholder'   => '',
                    'default'       => '0',
